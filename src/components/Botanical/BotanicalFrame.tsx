...
export const EngravedBranchLeft: React.FC<BotanicalProps> = ({ 
  className = "w-28 h-40 md:w-44 md:h-64", 
  color = "var(--olive)" 
}) => (
  <svg 
    viewBox="0 0 160 220" 
...
export const EngravedWreath: React.FC<BotanicalProps> = ({ 
  ...
  <svg 
    ...
    className={`select-none pointer-events-none ${className}`}
  >
    {/* Fine Hand-drawn Wreath Circles */}
...
export const EngravedDivider: React.FC<BotanicalProps> = ({ 
  ...
  >
    {/* Left Hairline Rule with Botanical Leaf */}
    ...
    {/* Right Hairline Rule with Botanical Leaf */}
